...
class TestParent < TestModel
  ...
  has_many :children, predicate: ActiveFedora::RDF::Fcrepo::RelsExt.isPartOf, class_name: 'TestChild'
end

class TestChild < TestModel
  belongs_to :parent, predicate: ActiveFedora::RDF::Fcrepo::RelsExt.isPartOf, class_name: 'TestParent'
end
...
FactoryGirl.define do
  ...
  factory :test_child do
    dc_title [ "Ddr Test Child Object" ]
  ...
  factory :test_content do
    dc_title [ "Ddr Test Content Object" ]
  ...
  factory :test_model_omnibus do
    dc_title [ "Ddr Test Omnibus Object" ]
    sequence(:dc_identifier) { |n| [ "test%05d" % n ] }
    after(:build) do |c|
      c.upload File.new(File.join(Ddr::Models::Engine.root.to_s, "spec", "fixtures", "imageA.tif"))
    end
